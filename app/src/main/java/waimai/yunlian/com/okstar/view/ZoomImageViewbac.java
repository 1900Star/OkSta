...
public class ZoomImageViewbac
		extends
ImageView implements OnGlobalLayoutListener, OnScaleGestureListener, OnTouchListener {
	...
	public ZoomImageViewbac(Context context, AttributeSet attrs, int defStyle) {
	...
	public ZoomImageViewbac(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ZoomImageViewbac(Context context) {
		this(context, null);
	}
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN :
			...
			if (f.width()>getWidth()+0.01||f.height()>getHeight()+0.01) {
